                ...
                <div className="row">
                    <div className="col-6">
                        <div className="centered p-2">
                            <h1 className="Side1Title"> There's no <s>perfect project</s>, but <mark>well structured
                                project.</mark> <i className="em em-facepunch" aria-role="presentation" aria-label="FISTED HAND SIGN"></i> <i className="em em-sunglasses" aria-role="presentation" aria-label="SMILING FACE WITH SUNGLASSES"></i>
                            </h1>
